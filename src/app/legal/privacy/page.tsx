  ...
  return (
    <div className="min-h-screen bg-brand-cream py-24 px-6">
      <div className="max-w-3xl mx-auto bg-brand-cream p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
        <h1 className="text-3xl font-semibold text-brand-dark-brown mb-6">Privacy Policy</h1>
        <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-normal text-brand-dark-brown mt-8 mb-4">1. Personal Information We Collect</h2>
          ...
          <h2 className="text-xl font-normal text-brand-dark-brown mt-8 mb-4">2. How We Use Your Personal Information</h2>
          <p>We use the Order Information that we collect generally to fulfill any orders placed through the Site (including processing your payment information, arranging for shipping, and providing you with invoices and/or order confirmations).</p>
          
          <h2 className="text-xl font-normal text-brand-dark-brown mt-8 mb-4">3. Data Retention</h2>
