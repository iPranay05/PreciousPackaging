  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] py-24 px-6">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
        <h1 className="text-3xl font-black text-[#0A2540] mb-6">Shipping Policy</h1>
        <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-[#0A2540] mt-8 mb-4">1. Processing Time</h2>
          ...
          <h2 className="text-xl font-bold text-[#0A2540] mt-8 mb-4">2. Shipping Rates and Estimates</h2>
          ...
          <h2 className="text-xl font-bold text-[#0A2540] mt-8 mb-4">3. Order Tracking</h2>
          <p>When your order has shipped, you will receive an email notification from us which will include a tracking number you can use to check its status. Please allow 48 hours for the tracking information to become available.</p>
          
          <h2 className="text-xl font-bold text-[#0A2540] mt-8 mb-4">4. Domestic Shipping Only</h2>
