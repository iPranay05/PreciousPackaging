  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] py-24 px-6">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
        <h1 className="text-3xl font-black text-[#0A2540] mb-6">Refund and Cancellation Policy</h1>
        <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-[#0A2540] mt-8 mb-4">1. Cancellations</h2>
          ...
          <h2 className="text-xl font-bold text-[#0A2540] mt-8 mb-4">2. Returns</h2>
          ...
          <h2 className="text-xl font-bold text-[#0A2540] mt-8 mb-4">3. Refunds</h2>
          ...
          <h2 className="text-xl font-bold text-[#0A2540] mt-8 mb-4">4. Process</h2>
