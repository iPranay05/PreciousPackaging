...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-[#f9f9f9] py-24 px-6 flex items-center justify-center">
      <div className="max-w-2xl w-full bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 text-center">
        ...
        <h1 className="text-3xl font-black text-[#0A2540] mb-4">Contact Us</h1>
