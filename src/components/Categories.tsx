...
const categories = [
  { id: 1, name: "MAILERS", size: "col-span-12 md:col-span-8", src: "/images/category_mailer.png", bg: "bg-[#FEF4E8]" },
  { id: 2, name: "POUCHES", size: "col-span-6 md:col-span-4", src: "/images/category_pouch.png", bg: "bg-[#E8F4FE]" },
  ...
  return (
    <section className="py-20 bg-[#fafafa]" id="categories">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl md:text-5xl font-black text-center text-black mb-16 tracking-tighter">SHOP BY CATEGORY</h2>
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="relative z-10 w-full flex justify-between items-end mt-auto">
                <div className="bg-white/95 backdrop-blur px-6 py-4 md:px-8 md:py-5 rounded-2xl shadow-lg border border-white/20 transform transition-transform duration-500 group-hover:-translate-y-2">
                  <h3 className="font-black tracking-widest uppercase text-lg md:text-xl text-[#0A2540]">{category.name}</h3>
                  <p className="text-gray-500 text-xs md:text-sm font-medium mt-1">Explore Collection</p>
                </div>
                
                <div className="hidden sm:flex w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/95 backdrop-blur items-center justify-center shadow-lg text-[#0A2540] transform transition-transform duration-500 group-hover:-translate-y-2 group-hover:bg-[#0A2540] group-hover:text-white">
