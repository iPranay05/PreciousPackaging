...
export default function Testimonials() {
  return (
    <section className="py-24 bg-[#FEF4E8] overflow-hidden" id="testimonials">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl md:text-5xl font-black text-black text-center mb-16 tracking-tighter">LOVED BY BRANDS</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((item, index) => (
            <motion.div 
              ...
              className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-black/5 flex flex-col justify-between"
            >
              <div>
                <div className="flex gap-1 mb-6 text-[#0A2540]">
              ...
              <div>
                <p className="font-bold text-black uppercase tracking-widest text-sm">{item.author}</p>
